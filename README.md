...
### If PR the title includes `Major`, the version will be incremented from 0.0.0 to 1.0.0
### If PR the title includes `Minor`, the version will be incremented from 0.0.0 to 0.1.0 
### If PR the title includes `Patch`, the version will be incremented from 0.0.0 to 0.0.1 
